"""Asynchronous Avatron client using httpx."""
...
class AsyncAvatronClient:
    """Asynchronous client for the Avatron REST API.
    ...
    async def __aenter__(self) -> AsyncAvatronClient:
        return self
